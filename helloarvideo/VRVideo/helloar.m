...
//                    } else if ([target_name isEqualToString:@""] && [[video_renderers objectAtIndex:1] texid] != 0) {
//                        video = [[ARVideo alloc] init];
//                        [video openTransparentVideoFile:@"video.mp4" texid:[[video_renderers objectAtIndex:1] texid]];
...
//                        video = [[ARVideo alloc] init];
//                        [video openStreamingVideo:@"http://img.dpm.org.cn/Uploads/File/2018/04/19/haitang.mp4" texid:[[video_renderers objectAtIndex:2] texid]];//https://sightpvideo-cdn.sightp.com/sdkvideo/EasyARSDKShow201520.mp4
